...
const Descriptions = {
    ...
    "neither": {
        ...
        "poor": [ "I'm not sure if they had anything to eat today or could afford the meal.", "Their clothes look kinda dirty"],
...
const ReactionsNarration = {
    "male": {
		"denied": [ "He walks away...", "He goes over to take a look at other animals.", "He turns to check out other pets.", "He's no longer interested.", "Another pet gained his attention." ],
		"disappointed": [ "He looks a little disappointed.", "He backs away a bit from you.", "He's not looking at you too intently.", "You might need to impress him a bit more." ],
		"neutral": [ "He watches you cautiously.", "He seems unsure about you.", "He's only half-looking at what you're doing." ],
		"interested": [ "He takes a closer look at you.", "He walks a bit closer.", "You got his attention.", "He seems to like you.", "He looks at you more intently.", "He turns directly toward you" ],
		"veryinterested": [ "It seems you have his full attention at the moment.", "You're the only pet he's looking at now.", "He seems to like you a lot.", "You're all he's interested in right now." ],
		"adopted": [ "He reaches over and picks you up.", "He asks the staff about you.", "He leans over to you and reaches out with his hand." ],
    },
    "female": {
        "denied": [ "She walks away...", "She goes over to take a look at other animals.", "She turns to check out other pets.", "She's no longer interested.", "Another pet gained her attention." ],
		"disappointed": [ "She looks a little disappointed.", "She backs away a bit from you.", "She's not looking at you too intently.", "You might need to impress her a bit more." ],
		"neutral": [ "She watches you cautiously.", "She seems unsure about you.", "She's only half-looking at what you're doing." ],
		"interested": [ "She takes a closer look at you.", "She walks a bit closer.", "You got her attention.", "She seems to like you.", "She looks at you more intently.", "She turns directly toward you" ],
		"veryinterested": [ "It seems you have her full attention at the moment.", "You're the only pet she's looking at now.", "She seems to like you a lot.", "You're all she's interested in right now." ],
		"adopted": [ "She reaches over and picks you up.", "She asks the staff about you.", "She leans over to you and reaches out with her hand." ],
    },
    "neither": {
        "denied": [ "They walk away...", "They go over to take a look at other animals.", "They turn to check out other pets.", "They're no longer interested.", "Another pet gained their attention." ],
		"disappointed": [ "They look a little disappointed.", "They back away a bit from you.", "They're not looking at you too intently.", "You might need to impress them a bit more." ],
		"neutral": [ "They watch you cautiously.", "They seem unsure about you.", "They're only half-looking at what you're doing." ],
		"interested": [ "They take a closer look at you.", "They walk a bit closer.", "You got their attention.", "They seem to like you.", "They look at you more intently.", "They turn directly toward you" ],
		"veryinterested": [ "It seems you have their full attention at the moment.", "You're the only pet they're looking at now.", "They seem to like you a lot.", "You're all they're interested in right now." ],
		"adopted": [ "They reach over and pick you up.", "They ask the staff about you.", "They lean over to you and reaches out with their hand." ],
    },
};
